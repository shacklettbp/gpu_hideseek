...
arg_parser.add_argument('--steps-per-update', type=int, default=160)
arg_parser.add_argument('--num-bptt-chunks', type=int, default=16)
...
policy = make_policy(num_obs_features, args.num_channels)

actions = sim.action_tensor().to_torch()[0:args.num_worlds * 5, ...]
dones = sim.done_tensor().to_torch()[0:args.num_worlds * 5, ...]
rewards = sim.reward_tensor().to_torch()[0:args.num_worlds * 5, ...]
